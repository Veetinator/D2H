...
import './iPhone14Pro1.dart';

class iPhone14Pro2 extends StatelessWidget {
  iPhone14Pro2();
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.004, -0.273),
            child: SizedBox(
              width: 146.0,
              height: 30.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(0.091, 0.089),
            child: Container(
              width: 151.0,
              height: 51.0,
              decoration: BoxDecoration(
          ...
          Align(
            alignment: Alignment(0.09, 0.085),
            child: SizedBox(
              width: 114.0,
              height: 21.0,
              child: Text(
