...
import './iPhone14Pro15.dart';
import 'package:adobe_xd/page_link.dart';

class iPhone14Pro14 extends StatelessWidget {
  iPhone14Pro14();
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 40.0, end: 59.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  duration: 0,
                  pageBuilder: () => iPhone14Pro15(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
